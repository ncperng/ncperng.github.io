...
ol
	li
		| Chai-Hien Gan, Phone Lin, 
		em Nei-Chiung Perng
		| , Tei-Wei Kuo, and Ching-Chi Hsu,
...
//-
	li Chai-Hien Gan, Phone Lin, <em>Nei-Chiung Perng</em>, Tei-Wei Kuo, and Ching-Chi Hsu, 
	...
	li <em>Nei-Chiung Perng</em>, Chin-Shuang Liu, and Tei-Wei Kuo, 
	"Real-Time Linux with Budget-Based Resource Reservation," 
	Journal Information Science and Engineering, Vol.22, No.1, 2006.

	li Tsun-Yu Hsiao, <em>Nei-Chiung Perng</em>, Winston Lo, Yue-Shan Chang, and Shy-Ming Yuan,
	"A New Development Environment for an Event-Based Distributed System,"
	Computer Standard & Interfaces (CS&I),
	special issue on CORBA: protocols, applications, process models and standards,
	Vol.25, Issue 4, pp.345-355, August 2003.
	</ol>

	<h3>International Conferences</h3>
	<ol>
	li <em>Nei-Chiung Perng</em>, Jian-Jia Chen, and Tei-Wei Kuo,
	"The minimization of hardware size in reconfigurable embedded platforms,"
	Proceedings of the 2008 ACM Symposium on Applied Computing (SAC), 2008.

	li <em>Nei-Chiung Perng</em> and Shih-Hao Hung,
	...
	li <em>Nei-Chiung Perng</em>, Jian-Jia Chen, Chuan-Yue Yang, and Tei-Wei Kuo,
	"Energy-Efficient Scheduling on Multi-Context FPGA's," 
	IEEE International Symposium on Circuits and Systems (ISCAS), 2006.

	li Ya-Shu Chen, <em>Nei-Chiung Perng</em>, Chi-Sheng Shih, and Tei-Wei Kuo,
	...
	li <em>Nei-Chiung Perng</em>, Ai-Chun Pang, Tei-Wei Kuo, and Chuan-Yue Yang, 
	"A Tiny Real-Time Kernel for Embedded Systems,"
	International SoC Design Conference (ISOCC 2004).

	li Phone Lin, Chai-Hien Gan, <em>Nei-Chiung Perng</em>, Tei-Wei Kuo, and Ching-Chi Hsu,
	"Time Division Based Shared Channel Allocation Algorithm for UMTS," 
	IEEE Wireless Communications and Networking Conference (WCNC),
	Vol.2, pp.717-721, Mar 2004.

	li <em>Nei-Chiung Perng</em>, Neung-Tsung Tsai, Jen-Wei Hsieh, and Tei-Wei Kuo,
	...
	li Tsun-Yu Hsiao, Ruey-Kai Sheu, Kai-Chih Liang, <em>Nei-Chiung Perng</em>, and Shyan-Ming Yuan, 
	...
	ol
		li Chuan-Yue Yang, Yu-Kai Huang, <em>Nei-Chiung Perng</em>, Jian-Jia Chen, Yun-Han Lee, Chia-Mei Hung, Heng-Ruey Hsu, Szu-Wei Huang, Ai-Chun Pang, and Tei-Wei Kuo, 
	...
	ol
		li <em>Nei-Chiung Perng</em>, Cheng-Min Lien, Chi-Sheng Shih, and Tei-Wei Kuo,
		"On the Minimization of Buffer Memory for Hardware/Software Co-Synthesis Processes,"
		VLSI Design/CAD Conference, 2005.

		li <em>彭念劬</em>、蕭存喻、許瑞愷、袁賢銘, "以事件為基礎之分散式系統建構環境 (A Development Environment for Event-Based Distributed Systems)," 
		廿一世紀數位生活與網際網路科技研討會, 2001.

		li 高子漢、洪傳寶、許瑞愷、蕭存喻、<em>彭念劬</font></em>、袁賢銘, 
		"內文導向之訊息交換仲介層設計與實作,"
		廿一世紀數位生活與網際網路科技研討會, 2001.

		li <em>彭念劬</em>、鄭兆翔、黃宗元、王聖博、袁賢銘,
		"網路化啟發性幾何數學互動學習系統
		(Web-based Geometry Inter-Creative Learning System)," TANET 2000.

	h3 Others
	ol
		li <em>Nei-Chiung Perng</em>, 
